<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="USchedule.Themes.DaLifeGolfTheme.Edit" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="DaLifeGolfTheme" containersrc="Blank.ascx" />
