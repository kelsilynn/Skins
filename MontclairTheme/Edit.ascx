<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Uschedule.Themes.MontclairTheme.Edit" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="MontclairTheme" containersrc="Blank.ascx" />
